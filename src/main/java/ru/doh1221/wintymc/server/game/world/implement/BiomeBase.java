...
public class BiomeBase {
    ...
    public static final BiomeBase SWAMPLAND = (new BiomeBase()).b(522674).a("Swampland").a(9154376);
    ...
    public static final BiomeBase SAVANNA = (new BiomeBase()).b(14278691).a("Savanna");
    ...
    public static final BiomeBase DESERT = (new BiomeBase()).b(16421912).a("Desert").e();
    public static final BiomeBase PLAINS = (new BiomeBase()).b(16767248).a("Plains");
    public static final BiomeBase ICE_DESERT = (new BiomeBase()).b(16772499).a("Ice Desert").b().e().a(12899129);
    public static final BiomeBase TUNDRA = (new BiomeBase()).b(5762041).a("Tundra").b().a(12899129);
    public static final BiomeBase HELL = (new BiomeBase()).b(16711680).a("Hell").e();
    public static final BiomeBase SKY = (new BiomeBase()).b(8421631).a("Sky").e();
    public String n;
    public int o;
    public byte p;
    public byte q;
    ...
    protected BiomeBase() {
        this.p = (byte) BlockRegistry.getByBlockName("grass").getID();
        this.q = (byte) BlockRegistry.getByBlockName("dirt").getID();
        this.r = 5169201;
